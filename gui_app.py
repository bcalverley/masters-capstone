...
class CardScannerApp:
    ...
    def on_upload_clicked(self):
        ...
        prediction, confidence, _, _ = predict_card(
            self.model,
            self.training_set,
            processed
        )
    ...
    def on_capture_clicked(self):
        ...
        self.display_result(prediction, confidence, _, _)
    ...
    def on_batch_test_clicked(self):
        ...
        self.result_label.config(text="Running batch test...")
        self.root.update()

        output_file, count = run_batch_test(
            self.model,
            self.training_set,
            folder_path
        )
